...
const API_BASE_URL = "http://localhost:5222/api";             //comment if you want to use production build
// const API_BASE_URL = "https://flightspark.online/api";    // comment if you want to use development build
...
const FlightSearch: React.FC = () => {
  ...
  const handleSearch = async () => {
    ...
    if (!fromCity || !toCity || !date) {   // Tarkistetaan, että kaikki kentät on täytetty
    ...
    try {
      ...
      const [fromCityResponse, toCityResponse] = await Promise.all([  // Haetaan kaupunkien koodit
